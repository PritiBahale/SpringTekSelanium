...
public class AddToCart {
	...
	public static void addToCart(WebDriver driver ,String item) throws InterruptedException, IOException {
		 ...
		 * s.selectByValue("4"); String qty = s.getFirstSelectedOption().getText();
		 * Thread.sleep(5000);
		 * 
		 * String up = SearchRepository.unitPrice(driver).getText(); Thread.sleep(3000);
		 * 
		 ...
		 * Thread.sleep(3000);
		 * 
		 * System.out.println(item + " Quantity: " + qty + "  ||  Unit Price: " + up +
		 * "  ||  Total Price: " + tp);
		 */
